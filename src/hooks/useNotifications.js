...
//     () => axiosInstance.patch('/api/notifications/mark-all-read'),
//     {
//       onSuccess: () => {
...
//     (notificationId) => axiosInstance.patch(`/api/notifications/${notificationId}/mark-read`),
//     {
//       onSuccess: () => {
//         queryClient.invalidateQueries(['notifications', page]);
//         queryClient.invalidateQueries(['notifications-unread']);
...
//     (notificationId) => axiosInstance.delete(`/api/notifications/${notificationId}`),
//     {
//       onSuccess: () => {
//         queryClient.invalidateQueries(['notifications', page]);
//         queryClient.invalidateQueries(['notifications-unread']);
